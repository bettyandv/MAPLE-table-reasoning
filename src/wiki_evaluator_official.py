...
def main():
    ...
    parser.add_argument('--output_csv',
                    help='Optional path to output CSV file that logs each prediction result')
    ...
    #         print(f'Skipping directory: {filename}', file=sys.stderr)
    #         continue
    #     print('Reading dataset from', filename, file=sys.stderr)
    with open(args.tagged_dataset_path, 'r', encoding='utf8') as fin:
    ...
    if args.output_csv:
        ...
        csv_writer.writerow(['id', 'correct', 'target_values', 'predicted_values'])
